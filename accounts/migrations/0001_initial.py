    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrateur'), ('hr_manager', 'Responsable RH'), ('recruiter', 'Recruteur'), ('hiring_manager', 'Manager Recrutement')], default='recruiter', max_length=20)),
                ('phone', models.CharField(blank=True, max_length=20)),
