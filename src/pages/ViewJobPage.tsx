                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-gray-900 dark:text-white">
                      {job.location}
                      {job.remote_allowed && (
                        <span className="ml-2 text-xs bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300 px-2 py-1 rounded">
                          Télétravail
                        </span>
                      )}
                    </div>
              ...
              {job.applications_count &&
                ...
                job.views_count > 0 && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold text-gray-900 dark:text-white">
                      {Math.round(
                        (job.applications_count / job.views_count) * 100
                      )}
                      %
                    </span>
                  </div>
          ...
          <Card className="dark:bg-gray-800 dark:border-gray-700">
            ...
            <CardContent className="space-y-3">
              ...
              <Button
                ...
                className="w-full justify-start"
                onClick={() =>
                  window.open(`/jobs/${job.id}/public`, "_blank")
                }
              >
                  ...
                  <div className="flex items-center space-x-2 text-red-600 dark:text-red-400">
                    ...
                    <div>
                      ...
                      <div className="text-sm">
                        Cette offre a dépassé sa date limite de candidature.
                      </div>
                    </div>
                  </div>
                </CardContent>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              Êtes-vous sûr de vouloir supprimer l'offre "{job.title}" ? Toutes
